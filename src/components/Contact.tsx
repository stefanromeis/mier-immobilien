...
export default function Contact() {
  ...
  return (
    <section id="kontakt" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary-600 text-white py-4 rounded-xl hover:bg-primary-700 transition-colors font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
              >
                Nachricht senden
              </button>
            </form>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">+49 123 456 789</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">info@mier-immobilien.de</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden h-64">
              <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Karte Platzhalter</p>
                </div>
              </div>
            </div>
          </div>
